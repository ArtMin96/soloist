...
- **Overall:** **Phase 6 (Monitoring / self-healing) — `In progress`; Phase 5 (Dashboard UI) — `Done —
  ...
  (gate **212 = Rust 170 / UI 42**). Two new **C5 monitoring domains** (`core/metrics/`, `core/portscan/`),
