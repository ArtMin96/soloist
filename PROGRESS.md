...
1. Run `just lint && just test` first to confirm the baseline is still green (**102 tests**: core 74 /
   pty 10 / store 12 / UI 6). Phases 1–4 are all `Done — pending verify` (Phase 4 PR reviewed + all
   findings fixed this session); **Phase 5 is next.**
