...
`feat/phase-9-timers` (off `main`, commit `1532251`; **review fixes applied 2026-06-24** — single-sourced the
watched-idle/quorum rule across scheduler + façade, generalized the lease-named coordination helpers) — **PR #23
open** — gate green (core 290 / store 38 / ipc 14 /
