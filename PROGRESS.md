...
**◆ NEW (2026-08-09) — git integration: PRs 0–8 are built; start PR 9, the commit history viewer
...
cancellation signal are both waiting for their session-scoped caller.
