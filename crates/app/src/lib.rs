...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::trust_requests,
            commands::trust_request_approve,
            commands::trust_request_deny,
            commands::trust_grants,
            ...
            commands::set_project_notification_level,
            commands::set_command_notification_level,
            ...
            commands::git_pull_request_review,
            commands::git_merge_pull_request,
            commands::git_hand_off,
