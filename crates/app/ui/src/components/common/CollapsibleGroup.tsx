  ...
  return (
    <Collapsible open={open} onOpenChange={onOpenChange} className="select-none">
      ...
      >
        <ChevronRight
          aria-hidden
          className="size-3.5 text-icon-muted transition-transform duration-[var(--dur-control)] ease-spring-settle group-hover/collapsible-group:text-toolbar-control-foreground group-data-[state=open]/collapsible-group:rotate-90 motion-reduce:transition-none"
        />
        <span className="type-label min-w-0 truncate font-[550] tracking-[var(--tracking-label)] text-foreground group-hover/collapsible-group:text-toolbar-control-foreground">
          {label}
        </span>
