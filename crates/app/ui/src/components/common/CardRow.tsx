    ...
    >
      ...
      <CardContent className="flex items-center gap-0 p-0">
        <Button
          ...
          variant="ghost"
          onClick={onOpen}
          className="h-auto min-w-0 flex-1 cursor-pointer flex-col items-stretch gap-1.5 overflow-hidden rounded-none p-3 text-left whitespace-normal hover:border-transparent hover:bg-sidebar-row-hover hover:text-sidebar-accent-foreground hover:[--foreground:var(--theme-sidebar-foreground)] hover:[--muted-foreground:var(--theme-sidebar-muted-foreground)] hover:[box-shadow:none] active:bg-sidebar-row-active active:text-sidebar-accent-foreground active:[--foreground:var(--theme-sidebar-foreground)] active:[--muted-foreground:var(--theme-sidebar-muted-foreground)] active:not-aria-[haspopup]:scale-100 focus-visible:bg-sidebar-row-hover focus-visible:text-sidebar-accent-foreground focus-visible:[--foreground:var(--theme-sidebar-foreground)] focus-visible:[--muted-foreground:var(--theme-sidebar-muted-foreground)] focus-visible:ring-inset supports-backdrop-filter:hover:bg-sidebar-row-hover supports-backdrop-filter:hover:backdrop-blur-none supports-backdrop-filter:hover:backdrop-saturate-100 supports-backdrop-filter:active:bg-sidebar-row-active motion-reduce:transition-none [&>*]:min-w-0"
        >
          {children}
        </Button>
        {aside}
