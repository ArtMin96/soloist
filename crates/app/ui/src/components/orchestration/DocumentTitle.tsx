...
/** The document kinds sharing this rename-in-place title. */
export type DocumentKind = "scratchpad" | "diagram";
...
// The open document's title, renamed in place: it rests as the humanized title and becomes a text
...
export function DocumentTitle({ kind, name, onRename }: DocumentTitleProps) {
  ...
  const errorId = `${kind}-rename-error`;
  ...
  return (
    <div className="relative min-w-0 flex-1">
      <Input
        ...
        autoFocus
        value={draft}
        aria-label={`${capitalize(kind)} name`}
