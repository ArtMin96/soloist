...
pub use coordination::{
    ...
    ScratchpadLink, ScratchpadRef, ScratchpadRepo, ScratchpadSummary, ScratchpadView, Scratchpads,
    ...
    TodoStatus, TodoSummary, TodoView, TodoWriteResult, Todos, TransferResult, WriteError,
    WriteResult,
};
